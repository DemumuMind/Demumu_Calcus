...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <AdPlaceholder slot="home-top" size="leaderboard" className="mx-auto max-w-7xl px-4 my-8" />
      ...
      <AdPlaceholder slot="home-bottom" size="leaderboard" className="mx-auto max-w-7xl px-4 my-8" />
